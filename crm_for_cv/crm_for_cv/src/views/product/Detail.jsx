...
const Grids = lazy(() => import("../../components/card/CardProductGrid"));
const SizeChart = lazy(() => import("../../components/others/SizeChart"));
const StarZone =lazy(()=> import("../product/StarZone"));
const cable= lazy(()=>import("../product/cable"));
          ...
          <div className="col-md-8">
            <div className="row mb-3">
              <div className="col-md-5 text-center">
                <img
                  src="../../images/products/ibundle.jpg"
              ...
              <div className="col-md-7">
                ...
                <div className="mb-3">
                  ...
                  <span className="text-muted small">
                    42 subscriptions and 4 reviews
                  </span>
                </div>
                <dl className="row small mb-3">
                  <dt className="col-sm-3">Starting from</dt>
                ...
                <div className="mb-3">
                  <span className="font-weight-bold h5 mr-2">Rs.1900 </span>
                  <del className="small text-muted mr-2">Rs.2000</del>
                ...
                <div className="mb-3">
                  ...
                  <button
                    ...
                    title="Buy now"
                  >
                    <FontAwesomeIcon icon={faShoppingCart} /> Subscribe now
                  </button>
                </div>
                <div>
                  ...
                  <ul className="small">
                    <li>
                      24/7 Premium Internet Coverage.
                    </li>
                    <li>High speed data and Internet with a speed of upto 30 mbps for fast cable and Internet access.</li>
                    <li>High end gaming experience with lowest ping and on demand subscriptions to gaming packages.</li>
                  </ul>
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col-md-12">
                ...
                <div className="tab-content p-3 small" id="nav-tabContent">
                  ...
                  <Link to="/account/notification" className="btn btn-primary">Proceed to Packages</Link>
